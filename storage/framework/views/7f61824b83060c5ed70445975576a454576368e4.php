                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control border-white" name="search" value="<?php echo e(Cookie::get('search_transaction')); ?>" placeholder="Email người dùng...">
                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="/<?php echo e(Helper_Dashboard::get_patch()); ?>/<?php echo e(Helper_Dashboard::get_patch(2)); ?>/edit/<?php echo e($value->id); ?>" title="chỉnh sửa <?php echo e($value->email); ?>"><?php echo e($value->email); ?></a></td>
                                            <td><?php echo e($value->point); ?></td>
                                            <?php
                                            $app = DB::table('users')->select('app.name')->join('app','app.id','=','users.app_id')->where('users.id',$value->user_id)->first();
                                            ?>
                                            ...
                                            <td>
                                                <?php if(!$value->status): ?>
                                                <span class="badge bg-soft-success text-success shadow-none">Thành công</span>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"  x-placement="bottom-start" >
                                                        ...
                                                        <a class="dropdown-item text-danger" href="/<?php echo e(Helper_Dashboard::get_patch()); ?>/<?php echo e(Helper_Dashboard::get_patch(2)); ?>/status/<?php echo e($value->id); ?>/1"><i class="fe-lock"></i> Khóa</a>
                                                        <?php elseif($value->status==1): ?>
                                                        <a class="dropdown-item text-success" href="/<?php echo e(Helper_Dashboard::get_patch()); ?>/<?php echo e(Helper_Dashboard::get_patch(2)); ?>/status/<?php echo e($value->id); ?>/0"><i class="fe-check-circle"></i> Thành công</a>
                                                        <?php endif; ?>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\pgpoint\app\Modules/Dashboard/Views/transaction/index.blade.php ENDPATH**/ ?>