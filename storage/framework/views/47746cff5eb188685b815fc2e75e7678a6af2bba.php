        ...
        <div class="col-md-4">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text"  name="name" value="<?php echo e(old('name')); ?>" class="form-control form-control-sm" placeholder="* App name">
                </div>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\pgpoint\app\Modules/Dashboard/Views/app/add.blade.php ENDPATH**/ ?>